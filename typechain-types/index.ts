...
export type { ICodeTrust } from "./decentralized-code-trust/contracts/interfaces/ICodeTrust";
export { ICodeTrust__factory } from "./factories/decentralized-code-trust/contracts/interfaces/ICodeTrust__factory";
